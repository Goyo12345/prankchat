...
const server = http.createServer((req, res) => {
  ...
  // Statistiques publiques agrégées, sans données personnelles.
  if (new URL(req.url, 'http://localhost').pathname === '/stats') {
    require('./admin-stats').handleStats(req, res, stripe, STRIPE_PRICE_ID)
    return
  }
